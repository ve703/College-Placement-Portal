...
import { Avatar, ListItem, Stack,List, ListItemText, ListItemButton, Divider } from '@mui/material';
import {
    createTheme,
    responsiveFontSizes,
    ThemeProvider,
...
let theme = createTheme({
  ...
  function createData(Certificates, Specialization, Institute, PassingYear, BoardUniversity,Percentage) {
    return { Certificates, Specialization, Institute, PassingYear, BoardUniversity,Percentage };
  }
  ...
  return (
    <Box sx={{m:2}}>
            ...
            <Stack direction="row" spacing={2} sx={{width:500,height:100}}>
                <Avatar sx={{width:80,height:80,border: '2px solid blue'}} src={vedu}/>
                    <div>
